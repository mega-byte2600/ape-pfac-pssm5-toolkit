...
def build_toolkit():
    return {
        "schema_version": "pfac-pssm5-toolkit-3",
        "project": {
            "name": "PFAC PSSM 5 Leadership Toolkit",
            "identity": "MPH Applied Practice Experience product",
            "scope": "PSSM 5 Patient and Family Engagement",
            "motto": "Patients over payers, bureaucracy, and internal convenience.",
            "service_thesis": "Patient experience is safety, dignity, trust, listening, escalation, follow-through, and survival.",
        ...
        "story_anchor": {
            ...
            "resource_layer": "Story and acknowledgement source. The formal bibliography remains the research and standards layer.",
        },
        "competencies": [
        ...
        "playbook_steps": [
            {"title": "Anchor the work to PSSM 5", "leader_action": "Define the work as PSSM 5 Patient and Family Engagement.", "patient_benefit": "Patient and family voice has a protected lane tied to safety and engagement.", "guardrail": "Prevents scope drift and paperwork-driven participation.", "artifact": "PSSM 5 scope statement."},
        ...
        "peer_models": [
            ...
            {"name": "AMA STEPS Forward PFAC Toolkit with Johns Hopkins", "type": "Practice-oriented PFAC implementation toolkit", "what_to_learn": "Leadership support, interviewing and selecting members, advisor recruitment, onboarding, and a first project are essential.", "how_we_improve": "Add the Rosie Bartel loved-one test, infection and escalation use case, and leadership closed-loop accountability."},
        ...
        "evidence": [
            {"source": "AHRQ PSSM Domain 5", "claim": "PSSM Domain 5 centers Patient and Family Engagement and includes PFAC input on safety.", "patient_benefit": "Patient and family voice is built into safety structure rather than handled after harm or complaints.", "risk_if_ignored": "The organization may document participation without creating a real safety or experience feedback loop.", "leadership_use": "Anchors the toolkit to PSSM 5 requirements."},
